...
public class XmlDocumentEntryGDataSerializer extends XmlEntryGDataSerializer {

	public XmlDocumentEntryGDataSerializer(XmlParserFactory factory, Entry entry) {
		super(factory, entry);
	}
